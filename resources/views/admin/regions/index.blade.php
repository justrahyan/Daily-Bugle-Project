        ...
        <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
            ...
            <form action="{{ route('admin.regions.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Nama" autofocus>
                </div>
    ...
    <div id="edit-region-modal" class="fixed inset-0 hidden bg-gray-800 bg-opacity-75 z-50 flex items-center justify-center">
        <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
            ...
            <form id="edit-region-form" method="POST">
                ...
                <div class="mb-4">
                    <label for="name" class="block text-gray-700 font-bold mb-2">Nama:</label>
                    <input type="text" name="name" id="edit-region-name" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Nama" autofocus>
                </div>
                <div class="text-center">
                    <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded shadow hover:bg-blue-700 focus:bg-blue-700 focus:outline-none">Submit</button>
