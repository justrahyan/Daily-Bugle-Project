    ...
    <div class="w-full mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="dark:bg-gray-800 p-6 rounded-lg shadow-lg mb-6">
                <h1 class="text-4xl font-bold mb-4 text-gray-900 dark:text-white">{{ $news->title }}</h1>
                <div class="flex flex-wrap items-center text-gray-600 dark:text-gray-400 mb-4 space-x-4">
                    ...
                    <div class="flex items-center text-sm mb-2">
                        ...
                        <span>{{ $news->views }} orang</span>
                    </div>
                </div>
                <!-- Image Section -->
                <div class="relative w-full h-96 overflow-hidden rounded-lg shadow-lg mb-4">
                    <img class="absolute inset-0 w-full h-full object-cover" src="{{ asset('storage/' . $news->image_url) }}" alt="{{ $news->title }}">
                </div>
                <!-- Image Caption -->
                <p class="text-sm text-gray-600 dark:text-gray-400 mb-4 text-center">{{ $news->image_caption }}</p>
                <!-- Content Section -->
                <div class="prose dark:prose-dark max-w-none">
                    <p class="text-lg text-gray-800 dark:text-gray-300 leading-relaxed">{{ $news->body }}</p>
                </div>
            </div>
